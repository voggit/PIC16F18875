...
INIT
    MOVLW B'00000001' ; Turns on RA4 LED
    MOVWF PORTB; Moves bit from W to f register.
    CALL DELAY
    MOVLW B'00000010' ; Turns off LED
    MOVWF PORTB ;Moves bit from W to f register
    CALL DELAY
    MOVLW B'00000100' ; Turns off LED
    MOVWF PORTB ;Moves bit from W to f register
    CALL DELAY
    MOVLW B'00001000' ; Turns off LED
    MOVWF PORTB ;Moves bit from W to f register
    CALL DELAY
    MOVLW B'00000100' ; Turns off LED
    MOVWF PORTB ;Moves bit from W to f register
    ...
    MOVWF PORTB ;Moves bit from W to f register
    CALL DELAY
    MOVLW B'00000001' ; Turns off LED
    MOVWF PORTB ;Moves bit from W to f register
    CALL DELAY
    GOTO INIT
